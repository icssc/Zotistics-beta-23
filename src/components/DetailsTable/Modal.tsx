            ...
            <Dialog as="div" className="relative z-10" onClose={() => setIsOpen(false)}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="relative flex flex-col w-full max-w-6xl min-w-[50vw] max-h-[65vh] sm:max-h-[75vh] transform rounded-2xl bg-white pb-10 text-left align-middle shadow-xl transition-all px-0 dark:bg-[#161616]">

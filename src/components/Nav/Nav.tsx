...
const Nav = () => {
  return (
    <>
      <nav className="fixed w-full h-16 text-sm font-light dark:border-b bg-white/90 drop-shadow-lg text-neutral-500 dark:border-neutral-800 dark:bg-black/90 dark:text-neutral-200">

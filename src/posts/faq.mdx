...
This project is maintianed by the [ICSSC](https://studentcouncil.ics.uci.edu/) [Projects Committee](https://github.com/icssc-projects). You can view the source code on [GitHub](https://github.com/icssc-projects/Zotistics), or chat with us on [Discord](https://discord.gg/GzF76D7UhY).
